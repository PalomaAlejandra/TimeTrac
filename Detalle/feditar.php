        ...
        <div class="col-sm-12">
            <form action="editardetalle.php" method="POST">
                <div class="form-group">
                    <label for="Tareas">Nombre del Estatus</label>
                    <input type="text" name="Tareas" id="Tareas" class="form-control" placeholder="Ingresa el nombre de estado" value="<?php echo $fila['nombre_tarea'] ?>">
